...
const Page = async ({ params }: { params: { quesId: string; quesName: string } }) => {
    const [question, answers, upvotes, downvotes, comments] = await Promise.all([
        databases.getDocument(env.appwrite.databaseApiKey, env.appwrite.questionCollectionApiKey, params.quesId),
        ...
        databases.listDocuments(env.appwrite.databaseApiKey, env.appwrite.commentCollectionApiKey, [
            Query.equal("type", "question"),
            Query.equal("typeId", params.quesId),
            Query.orderDesc("$createdAt"),
        ]),
                    ...
                    <div className="w-full overflow-auto">
                        ...
                        <div className="mt-4 flex items-center justify-end gap-1">
                            ...
                            <div className="block leading-tight">
                                ...
                                <p>
                                    <strong>{author.prefs.reputation.toString()}</strong>
                                </p>
                            </div>
                        </div>
                        <Comments
